...
public class CarpoAnalogWatchFaceService extends CanvasWatchFaceService {
    private static final String TAG = "CarpoAnalogWFS";
    ...
    public static int getComplicationId(
            CarpoAnalogConfigRecyclerViewAdapter.ComplicationLocation complicationLocation) {
...
//            builder.setPeriodic(1000 * 10 * 60, 1000 * 5 * 60);
            ...
            mSharedPref =
                    context.getSharedPreferences(
                            getString(R.string.carpo_analog_preference_file_key),
                            Context.MODE_PRIVATE);

            mCalendar = Calendar.getInstance();

            setWatchFaceStyle(
                    new WatchFaceStyle.Builder(CarpoAnalogWatchFaceService.this)
                ...
                if (complicationData.getTapAction() != null) {
                    ...
                    ComponentName componentName =
                            new ComponentName(
                                    ...
                                    CarpoAnalogWatchFaceService.class);
        ...
        private void registerReceiver() {
            ...
            CarpoAnalogWatchFaceService.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            CarpoAnalogWatchFaceService.this.unregisterReceiver(mTimeZoneReceiver);
        }
