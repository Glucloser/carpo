 ...
 * {@link CarpoAnalogWatchFaceService} watch face's appearance and complications
 * via {@link com.example.android.wearable.watchface.config.CarpoAnalogConfigActivity}.
 */
public class CarpoAnalogConfigData {
    ...
    public static Class getWatchFaceServiceClass() {
        return CarpoAnalogWatchFaceService.class;
    }
     ...
     * {@link ViewHolder} types in {@link com.example.android.wearable.watchface.config.CarpoAnalogConfigRecyclerViewAdapter}.
     */
    ...
    public static class PreviewAndComplicationsConfigItem implements ConfigItemType {
        ...
        public int getConfigType() {
            return CarpoAnalogConfigRecyclerViewAdapter.TYPE_PREVIEW_AND_COMPLICATIONS_CONFIG;
        }
    }
    ...
    public static class MoreOptionsConfigItem implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return CarpoAnalogConfigRecyclerViewAdapter.TYPE_MORE_OPTIONS;
        }
    }
    ...
    public static class ColorConfigItem  implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return CarpoAnalogConfigRecyclerViewAdapter.TYPE_COLOR_CONFIG;
        }
    }
    ...
    public static class UnreadNotificationConfigItem  implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return CarpoAnalogConfigRecyclerViewAdapter.TYPE_UNREAD_NOTIFICATION_CONFIG;
        }
    }
    ...
    public static class BackgroundComplicationConfigItem  implements ConfigItemType {
        ...
        @Override
        public int getConfigType() {
            return CarpoAnalogConfigRecyclerViewAdapter.TYPE_BACKGROUND_COMPLICATION_IMAGE_CONFIG;
        }
    }
}