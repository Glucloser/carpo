...
/**
 * The watch-side config activity for {@link com.example.android.wearable.watchface.watchface.CarpoAnalogWatchFaceService}, which
 ...
 */
public class CarpoAnalogConfigActivity extends Activity {

    private static final String TAG = CarpoAnalogConfigActivity.class.getSimpleName();

    static final int COMPLICATION_CONFIG_REQUEST_CODE = 1001;
    static final int UPDATE_COLORS_CONFIG_REQUEST_CODE = 1002;

    private WearableRecyclerView mWearableRecyclerView;
    private CarpoAnalogConfigRecyclerViewAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new CarpoAnalogConfigRecyclerViewAdapter(
                getApplicationContext(),
                CarpoAnalogConfigData.getWatchFaceServiceClass(),
                CarpoAnalogConfigData.getDataToPopulateAdapter(this));
