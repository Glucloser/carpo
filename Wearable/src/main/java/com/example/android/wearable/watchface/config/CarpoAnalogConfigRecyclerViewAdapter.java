...
import com.example.android.wearable.watchface.model.CarpoAnalogConfigData;
import com.example.android.wearable.watchface.watchface.CarpoAnalogWatchFaceService;
 ...
 */
public class CarpoAnalogConfigRecyclerViewAdapter
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "CompConfigAdapter";

    /**
     * Used by associated watch face ({@link CarpoAnalogWatchFaceService}) to let this
    ...
    private ArrayList<CarpoAnalogConfigData.ConfigItemType> mSettingsDataSet;
    ...
    public CarpoAnalogConfigRecyclerViewAdapter(
            Context context,
            Class watchFaceServiceClass,
            ArrayList<CarpoAnalogConfigData.ConfigItemType> settingsDataSet) {
        ...
        mBackgroundComplicationId =
                CarpoAnalogWatchFaceService.getComplicationId(
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        CarpoAnalogConfigData.ConfigItemType configItemType = mSettingsDataSet.get(position);
        ...
        switch (viewHolder.getItemViewType()) {
            case TYPE_PREVIEW_AND_COMPLICATIONS_CONFIG:
                ...
                CarpoAnalogConfigData.PreviewAndComplicationsConfigItem previewAndComplicationsConfigItem =
                        (CarpoAnalogConfigData.PreviewAndComplicationsConfigItem) configItemType;
            ...
            case TYPE_MORE_OPTIONS:
                ...
                CarpoAnalogConfigData.MoreOptionsConfigItem moreOptionsConfigItem =
                        (CarpoAnalogConfigData.MoreOptionsConfigItem) configItemType;
            ...
            case TYPE_COLOR_CONFIG:
                ...
                CarpoAnalogConfigData.ColorConfigItem colorConfigItem = (CarpoAnalogConfigData.ColorConfigItem) configItemType;
            ...
            case TYPE_UNREAD_NOTIFICATION_CONFIG:
                ...
                CarpoAnalogConfigData.UnreadNotificationConfigItem unreadConfigItem =
                        (CarpoAnalogConfigData.UnreadNotificationConfigItem) configItemType;
            ...
            case TYPE_BACKGROUND_COMPLICATION_IMAGE_CONFIG:
                ...
                CarpoAnalogConfigData.BackgroundComplicationConfigItem backgroundComplicationConfigItem =
                        (CarpoAnalogConfigData.BackgroundComplicationConfigItem) configItemType;
    ...
    public class PreviewAndComplicationsViewHolder extends RecyclerView.ViewHolder
        ...
        private void launchComplicationHelperActivity(
            ...
            mSelectedComplicationId =
                    CarpoAnalogWatchFaceService.getComplicationId(complicationLocation);
            ...
            if (mSelectedComplicationId >= 0) {
                ...
                int[] supportedTypes =
                        CarpoAnalogWatchFaceService.getSupportedComplicationTypes(
                                complicationLocation);

                ComponentName watchFace =
                        new ComponentName(
                                currentActivity, CarpoAnalogWatchFaceService.class);
                ...
                currentActivity.startActivityForResult(
                        ComplicationHelperActivity.createProviderChooserHelperIntent(
                                ...
                                mSelectedComplicationId,
                                supportedTypes),
                        CarpoAnalogConfigActivity.COMPLICATION_CONFIG_REQUEST_CODE);
        ...
        public void initializesColorsAndComplications() {
            ...
            final int[] complicationIds = CarpoAnalogWatchFaceService.getComplicationIds();
        ...
        public void onClick(View view) {
            ...
            if (mLaunchActivityToSelectColor != null) {
                ...
                activity.startActivityForResult(
                        launchIntent,
                        CarpoAnalogConfigActivity.UPDATE_COLORS_CONFIG_REQUEST_CODE);
            }
        }
    }
